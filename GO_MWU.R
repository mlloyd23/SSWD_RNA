#THIS R SCRIPT WAs WRITTEN BY MIKHAIL MATZ AND IS AVAILABLE ONLINE
#AT https://github.com/z0on/GO_MWU
#I AM PROVIDING IT HERE TO SHOULD HOW I PERFORMED THE GO ENRICHMENT IN MY STUDY.
...
setwd("C:/Users/Melanie/Desktop/GO_MWU-master")
# Edit these to match your data file names: 
input="Rupdatedpn20.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
goAnnotations="go.txt" # two-column, tab-delimited, one line per gene, multiple GO terms separated by semicolon. If you have multiple lines per gene, use nrify_GOtable.pl prior to running this script.
...
#	absValue=-log(0.05,10),  # genes with the measure value exceeding this will be counted as "good genes". Specify absValue=0.001 if you are doing Fisher's exact test for standard GO enrichment or analyzing a WGCNA module (all non-zero genes = "good genes").
  ...
  colors=c("#cd6600ff", "#004f84", "#ffc544ff", "#068de8") # these are default colors, un-remar and change if needed
)
